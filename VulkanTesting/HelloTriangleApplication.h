...
//		vkFreeMemory(device, vertexBufferMemory, nullptr);
	...
	void createIndexBuffer() {
		...
		indexData.insert(indexData.end(), indexDataSmallBox.begin(), indexDataSmallBox.end());
		indexData.insert(indexData.end(), indexDataBigBox.begin(), indexDataBigBox.end());
		indexData.insert(indexData.end(), indexDataSceneBox.begin(), indexDataSceneBox.end());
	...
	void createCommandBuffers() {
		...
		for (size_t i = 0; i < commandBuffers.size(); i++) {
			...
			vkCmdDrawIndexed(commandBuffers[i], 36, 1, 0, 0, 0);  // small box
